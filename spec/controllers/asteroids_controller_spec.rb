...
RSpec.describe AsteroidsController, :type => :controller do
  ...
  describe "GET show" do
    it "assigns the requested asteroid as @asteroid" do
      asteroid = Asteroid.create! valid_attributes
      get :show, {:id => asteroid.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested asteroid as @asteroid" do
      asteroid = Asteroid.create! valid_attributes
      get :edit, {:id => asteroid.to_param}, valid_session
      expect(assigns(:asteroid)).to eq(asteroid)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Asteroid" do
        expect {
          post :create, {:asteroid => valid_attributes}, valid_session
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved asteroid as @asteroid" do
        post :create, {:asteroid => invalid_attributes}, valid_session
        expect(assigns(:asteroid)).to be_a_new(Asteroid)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested asteroid" do
        asteroid = Asteroid.create! valid_attributes
        put :update, {:id => asteroid.to_param, :asteroid => new_attributes}, valid_session
        asteroid.reload
      ...
      it "assigns the requested asteroid as @asteroid" do
        asteroid = Asteroid.create! valid_attributes
        put :update, {:id => asteroid.to_param, :asteroid => valid_attributes}, valid_session
        expect(assigns(:asteroid)).to eq(asteroid)
      end
    ...
    describe "with invalid params" do
      it "assigns the asteroid as @asteroid" do
        asteroid = Asteroid.create! valid_attributes
        put :update, {:id => asteroid.to_param, :asteroid => invalid_attributes}, valid_session
        expect(assigns(:asteroid)).to eq(asteroid)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested asteroid" do
      asteroid = Asteroid.create! valid_attributes
      expect {
        delete :destroy, {:id => asteroid.to_param}, valid_session
      }.to change(Asteroid, :count).by(-1)
    end
